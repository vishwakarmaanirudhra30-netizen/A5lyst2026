...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Groq API Fetch Function (Marked as async)
    async function fetchAIResponse(userQuery) {
        if (!CONFIG.API_KEY || CONFIG.API_KEY.includes("gsk_") === false) {
            return "Sir/Ma'am, Groq API key config.js me missing hai ya invalid hai.";
        }
    ...
    temperature: 0.5, // Lower temperature = strict system prompt adherence
    max_tokens: 250,   // Ensures response remains short and crisp
    messages: [
